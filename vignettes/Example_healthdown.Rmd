---
title: "Example_healthdown"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Example_healthdown}
...
In this article, we demonstrate how easy it is to ... <br>

```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("../man/figures/healthdown_example.gif")
```
Click here for the [full demo app](https://pega.shinyapps.io/election16/)

## Data
As described in the [Leafdown Introduction article.](https://hoga-it.github.io/leafdown/articles/Introduction.html), we need two 
types of data:
...
Explaining the gridstakeR elements

# Final Demo App

TODO: Update for gridstakeR
