...
- ```<grid_stack_item-id>_w``` returns the width of the item in number of rows
- ```<grid_stack_item-id>_h``` returns the height of the item in number of columns
- ```<grid_stack_item-id>_x``` returns the x-position of the item in number of columns
- ```<grid_stack_item-id>_y``` returns the y-position of the item in number of rows
